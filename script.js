...
if(sana[inter])  {
    ...
    console.log('wrong request!! choose between the firstName,lastName,job,age,frds');
}
 
console.log(`${sana.firstName} has ${sana.frds.length} friends,and his best friend is ${sana.frds[0]}`);
...
console.log(`${saniya.firtName} is a ${saniya.birthYear}-year old ${saniya.job}, and she ${saniya.licence}`);
